...
class SeasonStatsTest < Minitest::Test
  ...
  assert_equal season_20122013_game_id, @tracker.game_id_in_season("20122013")
  end
  ...
  assert_equal total_goals_by_team, @tracker.total_goals_by_season("20122013")
  end

  def test_shot_ratio_by_season
  shot_goal_ratio_by_team = {"3"=>18.0, "6"=>13.090909090909092, "5"=>80.0, "17"=>21.0}
  assert_equal shot_goal_ratio_by_team, @tracker.shot_ratio_by_season("20122013")
  end

  def test_minmax_shot_ratio_by_season
  minmax_ratio = [["6", 13.090909090909092], ["5", 80.0]]
  assert_equal minmax_ratio, @tracker.minmax_shot_ratio_by_season("20122013")
  end
